...
def run_ingest(data_root: str, batch_size: int = 8, image_size=(256,256), multi_class=False, num_workers=4, out_dir="./artifacts", augment_level='medium'):
...
if __name__ == "__main__":
    ...
    args = p.parse_args()
    run_ingest(args.data_root, args.batch_size, tuple(args.image_size), args.multi_class, args.num_workers, args.out_dir, args.augment_level)
